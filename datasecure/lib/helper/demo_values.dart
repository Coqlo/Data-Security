import 'package:datasecure/model/comment_model.dart';
import 'package:datasecure/model/post_model.dart';
import 'package:datasecure/model/user_model.dart';

class DemoValues {
  static final List<UserModel> users = [
    UserModel(
      id: "1",
      name: "Worrasak Khammuang",
      email: "worrasak.kh@gmail.com",
    ...
    UserModel(
      id: "2",
      name: "juthamas sriprasert",
      email: "juthamas@gmail.com",
      image: "assests/images/user.jpg",
      followers: 456,
    ...
    UserModel(
      id: "3",
      name: "thanapat todilokvej",
      email: "thanapat.to@gmail.com",
      image: "assests/images/user.jpg",
      followers: 789,
...
Repudiandae sint soluta ullam sunt eos id laborum. Veniam molestiae ipsa odit soluta in rerum amet. Deserunt rerum vero est eaque voluptas aspernatur ut voluptatem. Sint sed enim.""";
  ...
  static final List<PostModel> posts = [
    PostModel(
      ...
      imageURL: "assests/images/leaf.jpg",
